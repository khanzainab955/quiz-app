...
const quiz = [
    ...
    },
    {
      ...
      { question:"What is the correct way to declare a variable in JavaScript?",
       choices:["var myVariable = 1","let myVariable = 1","const myVariable = 1","all of the above"],
       answer:"all of the above" 
    },
    {
        question:"Which of the following keywords is used to define a variable in Javascript?",
        choices:["var","let","both a and b","none of teh above"],
        answer:"both and b"
    },
    {
        question:"How can a datatype be declared to be a constant type?",
      choices:["cons","var","let","conatant"],
        answer:"const",
    },
    {
     ...
     answer:"in",    
        ...
        },
        {
            ...
            choices:["document.write()","console.log()","window.aler()","all of the above"],
            answer:"all of the above",
        },
